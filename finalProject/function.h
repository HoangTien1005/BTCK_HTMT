...
void write_numberToFile(string path, string res, bool isLE = false);	
// ghi chuỗi ra file theo LE hoặc BE, theo ASCII hoặc UTF16
void write_stringToFile(string path, string res, bool isLE = false, bool isUTF16 = false);	
...
// đọc một số theo LE hoặc BE
string read_numberFromFile(string path, int offset, int size, bool isLE = false);
// đọc một chuỗi theo LE hoặc BE, theo ASCII hoặc UTF16
string read_stringFromFile(string path, int offset, int size, bool isLE = false, bool isUTF16 = false);
